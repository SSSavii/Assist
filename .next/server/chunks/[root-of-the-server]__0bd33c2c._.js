...
"[project]/.next-internal/server/app/api/referrals/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/src/app/api/referrals/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        const currentUser = findUserStmt.get(userData.id);
        if (!currentUser) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Current user not found in DB'
            }, {
                status: 404
            });
        }
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(referrals);
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0bd33c2c._.js.map