...
"[project]/.next-internal/server/app/api/admin/lots/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/src/app/api/admin/lots/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
;
;
const GET = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$adminAuth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withAdminAuth"])(async (_request)=>{
    try {
        const lots = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].prepare(`
...
const POST = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$adminAuth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withAdminAuth"])(async (request)=>{
    try {
        const body = await request.json();
        const { title, start_price, photoUrl, duration_hours, description, city, age } = body;
        if (!title || !start_price || !duration_hours) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Отсутствуют обязательные поля: title, start_price, duration_hours'
            }, {
                status: 400
            });
        }
    ...
    `);
        const result = stmt.run(title, description, photoUrl, city, age, start_price, start_price, expires_at);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            message: 'Лот успешно создан',
            lotId: result.lastInsertRowid
        }, {
            status: 201
        });
    } catch (error) {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'Ошибка сервера при создании лота'
        }, {
            status: 500
        });
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__324b9b4b._.js.map