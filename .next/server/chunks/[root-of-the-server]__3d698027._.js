...
__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].exec(`
...
`);
const insertTask = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].prepare(`
    INSERT OR IGNORE INTO tasks (id, task_key, title, reward_crystals)
    VALUES (@id, @task_key, @title, @reward_crystals)
`);
__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].transaction(()=>{
    insertTask.run({
        id: 1,
...
async function POST(req) {
    ...
    try {
        ...
        let finalUser;
        const findUserStmt = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].prepare('SELECT * FROM users WHERE tg_id = ?');
        const existingUser = findUserStmt.get(userData.id);
        if (existingUser) {
            console.log(`[DB LOGIC] User ${userData.id} FOUND. Updating...`);
            const updateUserStmt = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].prepare(`
        UPDATE users
      ...
      `);
            ...
            if (startParam && startParam.startsWith('ref_')) {
                ...
                if (!isNaN(refId)) {
                    const findReferrerStmt = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].prepare('SELECT id FROM users WHERE id = ?');
                    const referrer = findReferrerStmt.get(refId);
                    if (referrer) {
                        referredById = referrer.id;
                        const rewardTransaction = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].transaction(()=>{
                            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].prepare('UPDATE users SET balance_crystals = balance_crystals + ? WHERE id = ?').run(REFERRAL_BONUS, referredById);
                            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].prepare('UPDATE users SET cases_to_open = cases_to_open + 1 WHERE id = ?').run(referredById);
                        });
                        try {
                            rewardTransaction();
            ...
            const insertUserStmt = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].prepare(`
      ...
      `);
            ...
            const findNewUserStmt = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].prepare('SELECT * FROM users WHERE id = ?');
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3d698027._.js.map