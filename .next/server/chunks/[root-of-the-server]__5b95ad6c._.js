...
"[project]/.next-internal/server/app/api/tap/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/src/app/api/tap/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        const tapTransaction = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].transaction(()=>{
            const user = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].prepare('SELECT daily_taps_count, last_tap_date FROM users WHERE tg_id = ?').get(userData.id);
            if (!user) {
                return {
            ...
            if (user.last_tap_date !== today) {
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].prepare('UPDATE users SET daily_taps_count = 0, last_tap_date = ? WHERE tg_id = ?').run(today, userData.id);
                currentTaps = 0;
            }
      ...
      `).run(TAP_REWARD, userData.id);
            ...
            const newBalance = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].prepare('SELECT balance_crystals FROM users WHERE tg_id = ?').get(userData.id).balance_crystals;
            return {
                success: true,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5b95ad6c._.js.map