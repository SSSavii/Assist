...
function ShopPage() {
    const [userPluses, setUserPluses] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(2);
    ...
    const getRandomPrize = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(()=>{
        const random = Math.random();
        // 20% шанс на редкий приз, 80% на обычный
        const availablePrizes = random < 0.2 ? ALL_PRIZES.filter((p)=>p.type === 'rare') : ALL_PRIZES.filter((p)=>p.type === 'common');
        return availablePrizes[Math.floor(Math.random() * availablePrizes.length)];
    }, []);
    // Анимация прокрутки слотов
    const animateSlots = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((finalPrize)=>{
...
//# sourceMappingURL=src_app_%28main%29_auction_page_tsx_cdde670b._.js.map