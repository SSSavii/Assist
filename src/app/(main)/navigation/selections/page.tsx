...
export default function SelectionsPage() {
  ...
  const selections: SelectionItem[] = [
    {
      id: 1,
      title: "Лучшие статьи о бизнесе",
      link: "https://t.me/+6flpcSdc4sg5OTAy" // Замените на реальную ссылку
    },
    {
      id: 2,
      title: "Топ инструментов для работы",
      link: "https://t.me/+6flpcSdc4sg5OTAy"
    },
    {
      id: 3,
      title: "Полезные ресурсы для саморазвития и продуктивности",
      link: "https://t.me/+6flpcSdc4sg5OTAy"
    },
    {
      id: 4,
      title: "Книги для предпринимателей",
      link: "https://t.me/+6flpcSdc4sg5OTAy"
    }
  ];
  ...
  return (
    <>
      ...
      <div className="selections-wrapper">
        <main className="selections-container">
          {/* Плюс на фоне */}
