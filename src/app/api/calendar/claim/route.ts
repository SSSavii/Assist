...
const ADVENT_PRIZES: Record<number, { fileName: string; title: string }> = {
  ...
  29: { fileName: 'промпты_адвент.pdf', title: 'ChatGPT захватывает наш мир 😳/n И это хорошо, ведь он может облегчить тебе работу /n 🎁 Сегодня в Адвенте подборка из 13 промтов' },
  30: { fileName: '7_сервисов.pdf', title: '7 сервисов' },
};
